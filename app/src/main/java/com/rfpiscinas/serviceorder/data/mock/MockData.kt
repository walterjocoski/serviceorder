...
object MockData {
    ...
    val clients = listOf(
        Client(id = 1, name = "Condomínio Jardim das Flores",
            ...
            phone = "(11) 98765-4321", email = "contato@condominioflores.com.br", active = true),
        Client(id = 2, name = "Residência Silva", cpfCnpj = "123.456.789-00",
            address = "Av. Paulista, 1000 - Bela Vista, São Paulo - SP",
            phone = "(11) 91234-5678", email = "silva@email.com", active = true),
        Client(id = 3, name = "Condomínio Parque das Águas",
            cpfCnpj = "98.765.432/0001-10",
            address = "Rua das Águas, 456 - Morumbi, São Paulo - SP",
            phone = "(11) 99876-5432", email = "contato@parqueaguas.com.br", active = true),
        Client(id = 4, name = "Residência Costa", cpfCnpj = "987.654.321-00",
            address = "Rua dos Pinheiros, 789 - Pinheiros, São Paulo - SP",
            phone = "(11) 93456-7890", email = "costa@email.com", active = false)
    )

    val services = listOf(
        Service(id = 1, name = "Limpeza de Borda", type = "Limpeza", usesProducts = true),
        Service(id = 2, name = "Aplicação de Cloro", type = "Tratamento Químico", usesProducts = true),
        Service(id = 3, name = "Aspiração do Fundo", type = "Limpeza", usesProducts = false),
        Service(id = 4, name = "Limpeza de Filtro", type = "Manutenção", usesProducts = false),
        Service(id = 5, name = "Aplicação de Algicida", type = "Tratamento Químico", usesProducts = true),
        Service(id = 6, name = "Teste de pH", type = "Análise", usesProducts = false),
        Service(id = 7, name = "Escovação de Paredes", type = "Limpeza", usesProducts = false)
    )

    val products = listOf(
        Product(id = 1, name = "Cloro Granulado", unitMeasure = UnitMeasure.GRAMS),
        Product(id = 2, name = "Algicida", unitMeasure = UnitMeasure.ML),
        Product(id = 3, name = "Barrilha", unitMeasure = UnitMeasure.KG),
        Product(id = 4, name = "Clarificante", unitMeasure = UnitMeasure.ML),
        Product(id = 5, name = "Redutor de pH", unitMeasure = UnitMeasure.GRAMS),
        Product(id = 6, name = "Elevador de pH", unitMeasure = UnitMeasure.GRAMS)
    )

    val completedOrders = listOf(
        ServiceOrder(id = 1, clientId = 1, clientName = "Condomínio Jardim das Flores",
            ...
            items = listOf(
                ...
                ServiceOrderItem(id = 3, service = services[2], observations = "")
            )),
        ServiceOrder(id = 2, clientId = 2, clientName = "Residência Silva",
            clientAddress = "Av. Paulista, 1000 - Bela Vista, São Paulo - SP",
            employeeId = 1, employeeName = "João", status = OrderStatus.COMPLETED,
            startDateTime = "12/02/2024 09:00:00", endDateTime = "12/02/2024 10:00:00",
            items = listOf(
        ...
        ServiceOrder(id = 3, clientId = 3, clientName = "Condomínio Parque das Águas",
            ...
            employeeId = 1, employeeName = "João", status = OrderStatus.COMPLETED,
            startDateTime = "14/02/2024 07:30:00", endDateTime = "14/02/2024 10:30:00",
            items = listOf(
        ...
        ServiceOrder(id = 6, clientId = 2, clientName = "Residência Silva",
            clientAddress = "Av. Paulista, 1000 - Bela Vista, São Paulo - SP",
            employeeId = 2, employeeName = "Maria", status = OrderStatus.CREATED,
            startDateTime = "16/02/2024 14:00:00", endDateTime = null,
            items = listOf(
                ServiceOrderItem(id = 15, service = services[3], observations = ""),
                ServiceOrderItem(id = 16, service = services[2], observations = "")
            ))
    )
